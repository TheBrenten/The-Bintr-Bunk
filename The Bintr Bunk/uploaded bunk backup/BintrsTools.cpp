...
//extern Player* p;
//
//void playSound(sf::SoundBuffer* soundBuffer, vec* pos,
...
//    if (!pos) pos = &p->pos;
//    if (soundBuffer) {
//        activeSounds.emplace_back(new BintrSound(pos, pitchVel));
...
//        sf::Sound* sound = &(activeSounds[activeSounds.size() - 1]->sound);
//        sound->setVolume(volume);
//        sound->setPosition(obj->pos.x, obj->pos.y, -500);
//        sound->setMinDistance(minDist);
//        sound->setAttenuation(attenuation);
//        sound->setPitch(pitch*physRate / 60);
//        sound->setBuffer(*soundBuffer);
...
//{
//    playSound(soundBuffer, &p->pos, volume, pitch, minDist, attenuation, pitchVel);
//}
//
...
bool checkTerrain(vec pos)
{
    ...
    sf::Color color;
    color = sf::Color::Red;
    //if (debugDraw) new Dot(pos, color);
