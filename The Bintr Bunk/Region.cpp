...
// mutex for waiting for thread to delete regions
#include "mutex"
mutex regionThreadLock;
...
void Region::updateTexture()
{
    updating = true;
    texture.update(pixels, regionSize, regionSize, 0, 0);
    textureUpdated = true;
    updating = false;
}
